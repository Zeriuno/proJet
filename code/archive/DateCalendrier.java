...
public class DateCalendrier {
	...
	public static void main(String[] args) {
		...
		Duration.between(Instant.parse(date5 + ":00.000Z"), Instant.parse(date6 + ":00.000Z")).getSeconds();
		System.out.println(Duration.between(Instant.parse(date5 + ":00.000Z"), Instant.parse(date6 + ":00.000Z")).getSeconds()/3600);
	}
